package com.videoapp.opsrc.utils.bar;
...
import com.videoapp.libcommon.utils.OSUtils;
...
public class StatusBarUtil {
    ...
    /**
     * 如果MainActivity 里面的 Content  要设置   android:fitsSystemWindows="true"
     * 设置状态栏黑色字体图标，
    ...
    /**
     * 配合 setDarkMode 方法使用
     * 处理 7.0系统、华为手机等沉浸式状态栏问题
     *
     * @param activity
     */
    public static void setHuaWeiTopBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    public static void setImmersiveStatusBar(Activity activity, boolean fontIconDark) {
        ...
        if (fontIconDark) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                // 灰色
                setStatusBarColor(activity, R.color.gray);
            }
        }
    }
