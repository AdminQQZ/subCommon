...
public class WebViewOption implements Parcelable {
    ...
    protected WebViewOption(Parcel in) {
        ...
        this.userAgentSuffix = in.readString();
        this.hardwareAccelerated = in.readByte() != 0;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.userAgentSuffix);
        dest.writeByte(this.hardwareAccelerated ? (byte) 1 : (byte) 0);
    }
}
